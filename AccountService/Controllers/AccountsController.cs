...
public class AccountsController(IMediator mediator) : ControllerBase
{
    ...
    ///     <p>Валюта проверяется сервисом проверки валюты (placeholder позволяет задать ["USD", "EUR", "RUB", "KZT"]).</p>
    ///     <p>Тип транзакции из enum: Credit - пополнение, Debit - списание.</p>
    ...
    ///     <p>Для fromAccount создается Debit транзакция (списание).</p>
    ///     <p>Для toAccount создается Credit транзакция (пополнение).</p>
